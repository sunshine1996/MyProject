...
/**
 * 
 * 名称：AbViewPagerAdapter.java 描述：一个通用的ViewPager适配器
 * 
 * @author zhaoqp
...
public class AbViewPagerAdapter extends PagerAdapter {
	...
	public AbViewPagerAdapter(Context context, ArrayList<View> mListViews) {
		...
		// 多添加两个，第一个，和最后一个。用于无限轮播。
		// mListViews.add(0, new View(context));
		// mListViews.add(mListViews.size()-1, new View(context));
	...
	@Override
	public int getCount() {
//		return mListViews.size()==0?0:Integer.MAX_VALUE;
