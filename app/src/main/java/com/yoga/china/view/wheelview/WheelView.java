...
package com.yoga.china.view.wheelview;
...
public class WheelView extends View {
	...
	/** 当前值与标签文本颜色 */
	private static int VALUE_TEXT_COLOR = 0xFF646663;

	/** 项目文本颜色 */
	private static int ITEMS_TEXT_COLOR = 0xFFACACAC;// 0xFF000000;
	 ...
	 * @param color
	 * 
	 * @author 孙思远 2015年6月11日 下午5:18:19
	 */
	 ...
	 * @param color
	 * 
	 * @author 孙思远 2015年6月11日 下午5:17:58
	 */
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.grey_middle));
		// 设置线宽
