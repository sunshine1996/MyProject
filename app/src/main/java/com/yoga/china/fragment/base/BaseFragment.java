...
/**
 * Created by sunsiyuan on 16/3/15.
 */
public abstract class BaseFragment extends Fragment {
    ...
    public void showToast(String content) {
        Tools.showToast(getActivity(), content);
    }
    ...
    protected void startAc(Intent intent, int reques_code) {
        ZYActivityTrans.startMove(getActivity(), intent, reques_code);
    }
    ...
    protected void finishAc(Intent intent, int result_code) {
        ZYActivityTrans.finishMove(getActivity(), intent, result_code);
    }
